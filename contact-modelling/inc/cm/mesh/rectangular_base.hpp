 ...
 * \endcond
 */
class MeshRectangularBase : public MeshInterface
{
public:
  /**
   ...
   */
  MeshRectangularBase(const size_t dim, const double dx, const double dy);
   ...
   * \endcond
   */
  MeshRectangularBase(const MeshInterface& base_mesh, const double dx, const double dy);

  /**
   * \brief   Similar to above, but changes the dimensionality of values to dim
   */
  MeshRectangularBase(const MeshInterface& base_mesh, const double dx, const double dy, const size_t dim);
  ...
  MeshRectangularBase& operator=(const MeshRectangularBase&) = default;
  MeshRectangularBase(const MeshRectangularBase&)            = default;
  MeshRectangularBase& operator=(MeshRectangularBase&&)      = default;
  MeshRectangularBase(MeshRectangularBase&&)                 = default;
  ~MeshRectangularBase()                                        = default;
